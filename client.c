...
void setUsername(connection_info *connection){
	message msg;
...
void killClient(connection_info *connection){
	close(connection->socket);
	exit(0);
}

//initialize connection to the server.
void connect(connection_info *connection, char *address, char *port){
...
void userOptions(connection_info *connection){
	char input[255];
...
void serverMessages(connection_info *connection){
	message msg;
